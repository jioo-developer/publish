...
add_javascript('<script src="'.G5_THEME_JS_URL.'/sub_nav.js"></script>', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/reset.css">', 1);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/footer.css">', 2);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/common.css">', 3);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/sub_common.css">', 4);
