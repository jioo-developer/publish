...
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/style2.css">', 1);
add_javascript('<script src="'.$board_skin_url.'/responsive.js"></script>', 0);
?>

<!-- 게시판 목록 시작 { -->
<section>
   <?php
    include("/home/rlawlgh3687/html/lawfirms/sidebar.php"); ?>
    ...
    <div class="s1_title_wrap">
        ...
        <div class="board_s2">
            <div class="s2_title s2_main_title">상담후기</div>
            <div class="s2_title s2_sub_title">
                법무법인 그날은 항상<br>
                마음이 지치신분들을 공감하며 상담합니다
            </div>
        </div>
        <div id="bo_gall" class="board">
